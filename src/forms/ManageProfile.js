                                        ...
                                        <Grid container spacing={2} >
                                            ...
                                            <Grid item xs={10} paddingTop={2} sm={10} md={6} lg={6}>
                                                ...
                                                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                                                    ...
                                                    <Box fullWidth sx={{ width: '70%', display: 'flex', flexDirection: 'row', justifyContent: 'start', marginTop: 2 }}>
                                                        ...
                                                        <TextField size='small' fullWidth variant="outlined" placeholder="Your Name" />
                                                    </Box>
                                                </Box>
                                                ...
                                                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                                                    ...
                                                    <Box sx={{ width: '70%', display: 'flex', flexDirection: 'column', alignItems: 'start', justifyContent: 'start' }}>
                                                        ...
                                                        <Box sx={{ width: '100%', marginTop: 1, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                                            <TextField size='small' sx={{ width: '33%', marginRight: 1 }} id="outlined-basic" label="City" variant="outlined" />
                                                            <TextField size='small' sx={{ width: '33%', marginRight: 1 }} id="outlined-basic" label="State" variant="outlined" />
                                                            <TextField size='small' sx={{ width: '33%' }} id="outlined-basic" label="Zip" variant="outlined" />
                                                ...
                                                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                                                    ...
                                                    <Box sx={{ width: '70%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                                        <TextField fullWidth size='small' sx={{ marginRight: 1 }} id="outlined-basic" label="Mobile" variant="outlined" />
                                                    </Box>
                                                </Box>
                                                ...
                                                <Box sx={{ display: 'flex', flexDirection: 'row', marginTop: 2 }}>
                                                    ...
                                                    <Box sx={{ width: '70%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                                        ...
                                                        <TextField fullWidth size='small' sx={{ marginRight: 1 }} id="outlined-basic" label="Email Id" variant="outlined" />
                                                    </Box>
                                                </Box>
